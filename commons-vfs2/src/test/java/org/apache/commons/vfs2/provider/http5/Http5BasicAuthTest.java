...
public class Http5BasicAuthTest {
    ...
    static void startServer() throws Exception {
        ...
        baseUri = AbstractProviderTestConfig.getLocalHostUriString("http5", server.getPort());
    }
    ...
    void testUnauthenticatedRequestReturns401() {
        assertThrows(FileSystemException.class,
                () -> VFS.getManager().resolveFile(baseUri + "/read-tests/file1.txt", new FileSystemOptions()).exists(),
