...
/**
 * JUnit 5 tests for FTP file systems with MDTM enabled.
 * <p>
 * MDTM is supported by default for underlying Apache MINA FTP server.
 * </p>
 */
public class FtpProviderMdtmOnTest extends ProviderTestSuiteJunit5 {
    ...
    public FtpProviderMdtmOnTest() throws Exception {
        super(new FtpProviderMdtmOnTestConfig(), "", false);
    }

    @Override
    protected void addBaseTests() throws Exception {
        addTests(FtpMdtmOnLastModifiedTests.class);
    }
    ...
    /**
     * Configuration for FTP provider tests with MDTM enabled.
     */
    private static class FtpProviderMdtmOnTestConfig extends AbstractProviderTestConfig {
