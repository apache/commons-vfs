...
/**
 * JUnit 5 tests for the ZIP file system with charset configuration.
 * <p>
 * This class replaces {@code ZipProviderWithCharsetTestCase} with a pure JUnit 5 implementation.
 * </p>
 */
public class ZipProviderWithCharsetTest extends ProviderTestSuiteJunit5 {

    public ZipProviderWithCharsetTest() throws Exception {
        super(new ZipProviderWithCharsetTestConfig(), "", true);
    }

    /**
     * Configuration for ZIP provider tests with charset.
     */
    private static class ZipProviderWithCharsetTestConfig extends AbstractProviderTestConfig {
