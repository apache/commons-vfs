...
public class ZipFileObjectTestCase {
    ...
    public void testLeaveNestedFileOpen() throws IOException {
        ...
        try (final FileObject zipFileObject = manager.resolveFile("commonscompresszip:file:" + newZipFile.getAbsolutePath())) {
            @SuppressWarnings({"resource"}) final FileObject zipFileObject1 = zipFileObject.resolveFile(NESTED_FILE_1);
