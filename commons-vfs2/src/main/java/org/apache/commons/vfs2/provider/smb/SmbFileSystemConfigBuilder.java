...
//    }
     ...
     *
     * @param options The FileSystemOptions.
     * @return A SmbFileType
     * @since 2.1
     */
    public SmbFileType getFileType(final FileSystemOptions options) {
        return getEnum(SmbFileType.class, options, FILE_TYPE);
    }

    /**
     * Gets the option to use SMB MDTM for {@link FileContent#getLastModifiedTime()}.
     *
     * @param options The FileSystemOptions.
    ...
    /**
     * Sets the control keep alive reply timeout for the SMB client.
     *
     * @param options  The FileSystem options.
...
//    }
     ...
     *
     * @param options     The FileSystemOptions.
     * @param smbFileType A SmbFileType
     * @since 2.1
     */
    public void setFileType(final FileSystemOptions options, final SmbFileType smbFileType) {
