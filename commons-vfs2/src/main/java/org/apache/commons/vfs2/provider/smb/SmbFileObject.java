...
public class SmbFileObject extends AbstractFileObject<SmbFileSystem> {
    ...
    private static final CIFSContext CTX = SingletonContext.getInstance();
    ...
    private SmbFile createSmbFile(final FileName fileName)
        ...
        try {
            ...
            if (authData != null) {
                auth = new NtlmPasswordAuthenticator(
                        UserAuthenticatorUtils.toString(UserAuthenticatorUtils.getData(authData, UserAuthenticationData.DOMAIN, UserAuthenticatorUtils.toChar(smbFileName.getDomain()))),
                        ...
                        UserAuthenticatorUtils.toString(UserAuthenticatorUtils.getData(authData, UserAuthenticationData.PASSWORD, UserAuthenticatorUtils.toChar(smbFileName.getPassword()))));
            }

            CIFSContext cifsContext = CTX.withCredentials(auth);
