...
public class NfsFileSystemConfigBuilder extends FileSystemConfigBuilder {
    ...
    private static final String _PREFIX = NfsFileSystemConfigBuilder.class.getName();
...
//    }
     ...
     * @since 2.1
     */
    protected NfsFileSystemConfigBuilder(final String prefix) {
        super(prefix);
    }
...
//    }
     ...
     *
     * @param options The FileSystemOptions.
     * @return A NfsFileType
     * @since 2.1
     */
    public NfsFileType getFileType(final FileSystemOptions options) {
        return getEnum(NfsFileType.class, options, FILE_TYPE);
    }

    /**
     * Gets the option to use NFS MDTM for {@link FileContent#getLastModifiedTime()}.
     *
     * @param options The FileSystemOptions.
    ...
    /**
     * Sets the control keep alive reply timeout for the NFS client.
     *
     * @param options  The FileSystem options.
...
//    }
     ...
     *
     * @param options     The FileSystemOptions.
     * @param smbFileType A NfsFileType
     * @since 2.1
     */
    public void setFileType(final FileSystemOptions options, final NfsFileType smbFileType) {
