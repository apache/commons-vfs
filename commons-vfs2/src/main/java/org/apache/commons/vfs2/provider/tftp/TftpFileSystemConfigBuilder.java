...
public class TftpFileSystemConfigBuilder extends FileSystemConfigBuilder {
    ...
    private static final String _PREFIX = TftpFileSystemConfigBuilder.class.getName();

    private static final TftpFileSystemConfigBuilder BUILDER = new TftpFileSystemConfigBuilder();
    ...
    private TftpFileSystemConfigBuilder() {
        super("tftp.");
    }
...
//    }
     ...
     * @since 2.1
     */
    protected TftpFileSystemConfigBuilder(final String prefix) {
        super(prefix);
    }
     ...
     */
    public static TftpFileSystemConfigBuilder getInstance() {
        return BUILDER;
    }
...
//    }
     ...
     *
     * @param options The FileSystemOptions.
     * @return A TftpFileType
     * @since 2.1
     */
    public TftpFileType getFileType(final FileSystemOptions options) {
        return getEnum(TftpFileType.class, options, FILE_TYPE);
    }

    /**
     * Gets the option to use tftp MDTM for {@link FileContent#getLastModifiedTime()}.
     *
     * @param options The FileSystemOptions.
    ...
    /**
     * Sets the control keep alive reply timeout for the tftp client.
     *
     * @param options  The FileSystem options.
